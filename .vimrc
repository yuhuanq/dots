...
" Plug 'scrooloose/syntastic', {'for': ['ocaml','c','cpp','java','javascript']}
...
" Color and style --- {{{
" alternate between base16, zenburn, and gruvbox mostly
syntax enable                   " enable syntax processing

" gruvbox
" set background=dark             " for gruvbox dark version
...
nnoremap <leader>ls :!leetcode submit %<CR>
